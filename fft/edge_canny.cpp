...
//         for (j=0;j<cols;j++)
//         {
//             fprintf(fp,"%d  ",smoothedim[(rows-i+1)*cols+j]);
//         }
//         fprintf(fp,"\n");
//     }
//     fclose(fp);
...
//         for (j=0;j<cols;j++)
//         {
//             fprintf(fp1,"%d  ",delta_x[(rows-i+1)*cols+j]);
//         }
//         fprintf(fp1,"\n");
//     }
//     fclose(fp1);
...
//         for (j=0;j<cols;j++)
//         {
//             fprintf(fp2,"%d  ",delta_y[(rows-i+1)*cols+j]);
//         }
//         fprintf(fp2,"\n");
//     }
//     fclose(fp2);
...
//     FILE *fp3;
//     fp3 = fopen("dy_dx.txt","wt");
//     //把结果数据写出去
//     for (i=0;i<rows;i++)
//     {
//         for (j=0;j<cols;j++)
//         {
//             fprintf(fp3,"%d  ",magnitude[(rows-i+1)*cols+j]);
//         }
//         fprintf(fp3,"\n");
//     }
//     fclose(fp3);
...
//     FILE *fp4;
//     fp4 = fopen("non_max.txt","wt");
//     //把结果数据写出去
//     for (i=0;i<rows;i++)
//     {
//         for (j=0;j<cols;j++)
//         {
//             fprintf(fp4,"%d  ",nms[(rows-i+1)*cols+j]);
//         }
//         fprintf(fp4,"\n");
//     }
//     fclose(fp4);
